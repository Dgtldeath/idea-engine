...
<head>
  ...
  <title>SphereSurge CRM – Contact & Touchpoint Management | Adam Gumm</title>
  <meta name="description" content="SphereSurge CRM: Custom-coded CRM for real estate agents. Managed contacts, smart touch-points, and content planning for social media.">
        ...
        <div class="col-lg-8">
          <div class="app-card p-4 p-md-5">
            <div class="d-flex align-items-center gap-3 mb-3">
              ...
              <div>
                <h1 class="h2 mb-1">SphereSurge <span>CRM</span></h1>
                <p class="mb-0 muted">Custom-coded CRM for myself and other real estate agents. Managed contacts, smart touch-points, and content planning for social media.</p>
              </div>
            </div>
      ...
      <div class="row g-4">
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            ...
            <p class="mb-0 small muted">Real estate agents and small teams needing lightweight CRM without enterprise pricing or complexity.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Problem Solved</h4>
            <p class="mb-0 small muted">Generic CRMs didn't handle touch-point reminders or social content planning. SphereSurge tracked contacts and prompted timely follow-ups.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Business Value</h4>
            <p class="mb-0 small muted">Never miss a follow-up. Smart touch-points kept relationships warm, while content planning kept social feeds active.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
      ...
      <div class="row mt-5">
        <div class="col-lg-8">
          <div class="app-card p-4 p-md-5">
            ...
            <ul class="muted mb-0">
              <li>Custom-coded CRM for myself and other real estate agents.</li>
              <li>Managed contacts, smart touch-points, and content planning for social media.</li>
            </ul>
            <p class="mt-3 mb-0 muted small">Year: 2020</p>
          </div>
        </div>
      </div>
    </div>
