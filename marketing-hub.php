...
<head>
  ...
  <title>The Marketing Hub – Social Media Management | Adam Gumm</title>
  <meta name="description" content="The Marketing Hub: Social media management tool with custom algorithms for automated tweet writing. Event, content, and speaker management.">
        ...
        <div class="col-lg-8">
          <div class="app-card p-4 p-md-5">
            <div class="d-flex align-items-center gap-3 mb-3">
              ...
              <div>
                <h1 class="h2 mb-1">The <span>Marketing Hub</span></h1>
                <p class="mb-0 muted">Social media management tool with custom algorithms for automated tweet writing. Event, content, and speaker management.</p>
              </div>
            </div>
      ...
      <div class="row g-4">
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            ...
            <p class="mb-0 small muted">Marketers, event organizers, and small teams managing social presence and content calendars.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Problem Solved</h4>
            <p class="mb-0 small muted">Keeping social feeds active required constant manual posting. Custom algorithms generated and suggested tweets based on content and events.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Business Value</h4>
            <p class="mb-0 small muted">Reduced time spent on repetitive posts while maintaining consistent voice. Event and speaker management in one place.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Tech Stack</h4>
            <p class="mb-0 small muted">Bootstrap CSS, Vanilla JavaScript, jQuery, Object-Oriented PHP, CSS, HTML, MySQL, AJAX.</p>
          </div>
        </div>
      </div>
      <div class="row mt-5">
        <div class="col-lg-8">
          <div class="app-card p-4 p-md-5">
            ...
            <ul class="muted mb-0">
              <li>Social media management tool with custom algorithms for automated tweet writing.</li>
              <li>Enabled event, content, and speaker management.</li>
            </ul>
            <p class="mt-3 mb-0 muted small">Year: 2018</p>
          </div>
        </div>
      </div>
    </div>
