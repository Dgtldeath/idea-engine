...
<head>
  ...
  <title>Wombat Juice Framework – Laravel-like CMS Framework | Adam Gumm</title>
  <meta name="description" content="Wombat Juice: Laravel-like framework built from scratch as a CMS. Tailored for client-specific functionality managing content on their websites.">
        ...
        <div class="col-lg-8">
          <div class="app-card p-4 p-md-5">
            <div class="d-flex align-items-center gap-3 mb-3">
              ...
              <div>
                <h1 class="h2 mb-1">"Wombat Juice" <span>Framework</span></h1>
                <p class="mb-0 muted">Laravel-like framework built from scratch as a CMS. Tailored for client-specific functionality managing content on their websites.</p>
              </div>
            </div>
      ...
      <div class="row g-4">
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            ...
            <p class="mb-0 small muted">Development teams and agencies needing a lightweight, custom CMS framework before Laravel was mainstream.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Problem Solved</h4>
            <p class="mb-0 small muted">Clients needed tailored content management without heavy enterprise CMS overhead. A modular MVC framework enabled rapid, project-specific builds.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Business Value</h4>
            <p class="mb-0 small muted">Early MVC adoption allowed clean separation of concerns and reusable components across client projects.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Tech Stack</h4>
            <p class="mb-0 small muted">Vanilla JavaScript, jQuery, PHP, CSS, HTML, MySQL, Custom MVC. Team-based development on early iterations.</p>
          </div>
        </div>
      </div>
      <div class="row mt-5">
        <div class="col-lg-8">
          <div class="app-card p-4 p-md-5">
            ...
            <ul class="muted mb-0">
              <li>Laravel-like framework built from scratch as a CMS.</li>
              <li>Tailored for client-specific functionality managing content on their websites.</li>
            </ul>
            <p class="mt-3 mb-0 muted small">Year: 2011 | Worked as part of a team on early iterations.</p>
          </div>
        </div>
      </div>
    </div>
