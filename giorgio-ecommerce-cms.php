...
<head>
  ...
  <title>Giorgio – E-Commerce CMS | Adam Gumm</title>
  <meta name="description" content="Giorgio: Custom ordering and delivery system routing to specific locations on kitchen iPads. Custom dashboard with charts and business analytics.">
        ...
        <div class="col-lg-8">
          <div class="app-card p-4 p-md-5">
            <div class="d-flex align-items-center gap-3 mb-3">
              ...
              <div>
                <h1 class="h2 mb-1">Giorgio: <span>E-Commerce CMS</span></h1>
                <p class="mb-0 muted">Custom ordering and delivery system routing to specific locations on kitchen iPads. Custom dashboard with charts and business analytics.</p>
              </div>
            </div>
      ...
      <div class="row g-4">
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            ...
            <p class="mb-0 small muted">Restaurants, catering kitchens, and food businesses needing order routing and fulfillment visibility.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Problem Solved</h4>
            <p class="mb-0 small muted">Kitchens struggled with order visibility and location-specific routing. Giorgio delivered orders to the right stations on iPads and tracked fulfillment.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Business Value</h4>
            <p class="mb-0 small muted">Faster fulfillment, fewer errors, and actionable analytics via custom dashboards. Kitchen staff could focus on cooking instead of routing.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Tech Stack</h4>
            <p class="mb-0 small muted">Vanilla JavaScript, jQuery, PHP, CSS, HTML, MySQL, AJAX. iPad-optimized UI for kitchen workflows.</p>
          </div>
        </div>
      </div>
      <div class="row mt-5">
        <div class="col-lg-8">
          <div class="app-card p-4 p-md-5">
            ...
            <ul class="muted mb-0">
              <li>Custom ordering and delivery system routing to specific locations on kitchen iPads.</li>
              <li>Custom dashboard with charts and business analytics.</li>
            </ul>
            <p class="mt-3 mb-0 muted small">Year: 2014</p>
          </div>
        </div>
      </div>
    </div>
