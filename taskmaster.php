...
<head>
  ...
  <title>TaskMaster – Smart To-Do List Manager | Adam Gumm</title>
  <meta name="description" content="TaskMaster: Custom-coded smart to-do list manager with hourly tracking and productivity dashboard. Auto-categorization, follow-ups, repeat tasks, time estimates.">
          ...
          <div class="app-card p-4 p-md-5">
            <div class="d-flex align-items-center gap-3 mb-3">
              <div class="app-icon bg-primary d-flex align-items-center justify-content-center">
                <i class="bi bi-check2-square text-white fs-2"></i>
              </div>
              <div>
                <h1 class="h2 mb-1">TaskMaster</h1>
                <p class="mb-0 muted">Custom-coded smart to-do list manager with hourly tracking and productivity dashboard. Auto-categorization, follow-ups, repeat tasks, and time estimates based on history.</p>
              </div>
            </div>
            <div class="d-flex flex-wrap gap-2 mb-3">
              <span class="badge stack-badge">Bootstrap CSS</span>
      ...
      <div class="row g-4">
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            ...
            <p class="mb-0 small muted">Freelancers, consultants, and knowledge workers who need visibility into time spent and productivity trends.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Problem Solved</h4>
            <p class="mb-0 small muted">Generic to-do apps don't track hours or learn from completion patterns. TaskMaster combined task management with time tracking and smart estimates.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Business Value</h4>
            <p class="mb-0 small muted">Accurate time estimates based on history, auto-categorization for organization, and follow-up task creation for recurring workflows.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Tech Stack</h4>
            <p class="mb-0 small muted">Bootstrap CSS, Vanilla JavaScript, jQuery, PHP, CSS, HTML, MySQL, AJAX.</p>
          </div>
        </div>
      </div>
      <div class="row mt-5">
        <div class="col-lg-8">
          <div class="app-card p-4 p-md-5">
            ...
            <ul class="muted mb-0">
              <li>Custom-coded smart to-do list manager with hourly tracking and productivity dashboard.</li>
              <li>Auto-categorization, task completion with follow-up creation, repeat tasks, and time estimates based on history.</li>
            </ul>
            <p class="mt-3 mb-0 muted small">Year: 2019</p>
          </div>
        </div>
      </div>
    </div>
