...
<head>
  ...
  <title>Photography E-Commerce Platform – Custom Multi-Media Platform | Adam Gumm</title>
  <meta name="description" content="Custom-coded photography e-commerce platform with digital currency tied to PayPal, supporting purchases, rentals, and gallery orders.">
        ...
        <div class="col-lg-8">
          <div class="app-card p-4 p-md-5">
            <div class="d-flex align-items-center gap-3 mb-3">
              ...
              <div>
                <h1 class="h2 mb-1">Photography <span>E-Commerce Platform</span></h1>
                <p class="mb-0 muted">Digital currency system tied to PayPal transactions. Supported purchases, rentals, and gallery orders. Multi-media e-commerce platform.</p>
              </div>
            </div>
            <div class="d-flex flex-wrap gap-2 mb-3">
              <span class="badge stack-badge">Bootstrap</span>
              <span class="badge stack-badge">jQuery</span>
              <span class="badge stack-badge">Custom PHP Framework</span>
      ...
      <div class="row g-4">
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            ...
            <p class="mb-0 small muted">Photographers, artists, and creatives selling digital and print media with flexible purchase and rental options.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Problem Solved</h4>
            <p class="mb-0 small muted">Existing platforms didn't support mixed purchase/rental models or custom digital currency. Built a tailored solution for media commerce.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Business Value</h4>
            <p class="mb-0 small muted">Flexible monetization: sell, rent, or offer gallery orders. PayPal integration with internal credit system for upsells and bundles.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="app-card p-4 h-100">
            <h4 class="h5 mb-3">Tech Stack</h4>
            <p class="mb-0 small muted">Bootstrap, Vanilla JavaScript, jQuery, Custom Object-oriented PHP Framework, CSS, HTML, AJAX, custom APIs.</p>
          </div>
        </div>
      </div>
      <div class="row mt-5">
        <div class="col-lg-8">
          <div class="app-card p-4 p-md-5">
            ...
            <ul class="muted mb-0">
              <li>Digital currency system tied to PayPal transactions.</li>
              <li>Supported purchases, rentals, and gallery orders.</li>
              <li>Multi-media e-commerce platform.</li>
            </ul>
            <p class="mt-3 mb-0 muted small">Year: 2021</p>
          </div>
        </div>
      </div>
    </div>
